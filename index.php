...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>LEYECO III Leave Portal</title>

	<!-- Site favicon -->
	<link rel="leyeco logo" sizes="180x180" href="vendors/images/leyeco logo.png">
	<link rel="icon" type="image/png" sizes="32x32" href="vendors/images/leyeco 32x32.png">
	<link rel="icon" type="image/png" sizes="16x16" href="vendors/images/logo 16x16.png">
	...
	<div class="login-header box-shadow">
		<div class="container-fluid d-flex  align-items-center flex-wrap justify-content-center">
			<div class="brand-logo">
				<a href="login.html">
					<img src="vendors/images/logo_leyeco3_v3.png" alt="">
				</a>
			</div>
		</div>
	</div>
				...
				<div class="col-md-8 col-lg-12">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-primary">LEYECO III LeavePortal</h2>
						</div>
